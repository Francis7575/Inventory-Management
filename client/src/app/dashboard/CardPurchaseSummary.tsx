		...
		<div className="flex flex-col justify-between row-span-2 xl:row-span-3 col-span-1 md:col-span-2 xl:col-span-1 bg-white shadow-md rounded-2xl">
			{isLoading ? (
				...
				<>
					{/* HEADER */}
					<div>
						<h2 className="text-lg font-semibold mb-2 pl-7 pt-5">
							Purchase Summary
						</h2>
						<hr />
					</div>
					...
					<div>
						...
						{/* CHART */}
						<ResponsiveContainer width="100%" height={containerHeight} className="p-2">
							<AreaChart
								data={purchaseData}
